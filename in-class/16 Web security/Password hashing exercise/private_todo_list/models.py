...
class User(models.Model):
    ...
    salt = models.CharField(max_length=42,default='my_salt')
    ...
    def check_password(self, password):
        hash_obj = hashlib.sha256()
        my_salt = self.salt
        hashed_pwd = hash_obj.update(password+my_salt)
        return hashed_pwd == self.password # Check user-typed password vs. stored password.
