...
urlpatterns = [
    ...
    url(r'^profile/(?P<username>.+)$',views.view_profile,name='view_profile'),
    ...
    url(r'^get-json-comments/',views.get_json_comments,name="get-json-comments"),
    url(r'^get-json-comments-followers',views.get_json_comments_followers),
    url(r'^get-json-comments-profile',views.get_json_comments_profile),
    url(r'^get-json-posts/',views.get_json_posts,name="get-json-posts"),
    url(r'^get-json-posts-followers/',views.get_json_posts_followers),
    url(r'^get-json-posts-profile',views.get_json_posts_profile),
