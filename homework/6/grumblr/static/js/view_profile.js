...
function populateCommentList() {
    var view_user_name = $('#view_user_name').val();
    // alert(view_user_name);
    $.get("/get-json-posts-profile",{'view_user_name':view_user_name})
        .done(function (data) {
            updatePostData(data);
            $.get("/get-json-comments-profile",{'view_user_name':view_user_name})
            .done(function(data) {
...
function refreshComment() {
    var view_user_name = $('#view_user_name').val();
    $.get("/get-json-comments-profile",{'view_user_name':view_user_name,'timestamp':$('#timestamp').val()})
      .done(function(data) {
          console.log(data);
            updateCommentData(data);
      });
...
function refreshPost() {
    var view_user_name = $('#view_user_name').val();
    $.get("/get-json-posts-profile",{'view_user_name':view_user_name,'timestamp':$('#timestamp').val()})
        .done(function (data) {
            console.log(data);
            updatePostData(data);
        });
